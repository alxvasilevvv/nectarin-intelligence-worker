...
### Email / Lifecycle group (v2.44+ — рассылки)
| Tool | What it does |
|---|---|
...
| Tool | What it does |
|---|---|
| `marketing_maturity_assessment` | **CMO/transformation scorecard (pro+).** Rate 7 weighted dimensions 0–5 ⇒ a 0–100 maturity index, level 1 Nascent→5 Leading, per-dimension strengths/gaps and a prioritized 90-day roadmap. |
...
| `win_loss_analysis` | **Win/loss (pro+).** From closed deals (outcome/reason/segment/value) ⇒ win rate by count & value, win rate by segment, top loss/win reasons and prioritized recommendations. |

### Ops & Autonomy group (v2.56+ — anomaly → action, CMO budgeting)
| Tool | What it does |
|---|---|
