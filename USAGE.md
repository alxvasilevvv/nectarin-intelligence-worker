...
Built‑in **prompts** (63): `build_media_plan`, `full_strategy`, `competitor_teardown`,
...
`alert_check`, `budget_split`, `win_loss_review`.
...
RU/CIS. У тебя подключён MCP-коннектор NECTARIN с 88 инструментами под 22
