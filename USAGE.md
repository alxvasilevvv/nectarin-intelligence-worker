...
Built‑in **prompts** (54): `build_media_plan`, `full_strategy`, `competitor_teardown`,
...
`retention_forecast`, `viral_growth`.
...
RU/CIS. У тебя подключён MCP-коннектор NECTARIN с 77 инструментами под 22
