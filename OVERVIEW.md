...
**AI-маркетинг-директор для рынка RU/CIS прямо в Claude.** MCP-коннектор с **60
детерминированными инструментами** и **37 готовыми сценариями (prompts)**, которые
...
- **37 готовых сценариев.** Нажал prompt — Claude сам вызывает нужные инструменты в
...
*NECTARIN Intelligence · 60 инструментов · 37 сценариев · Cloudflare Workers (edge,
