...
**AI-маркетинг-директор для рынка RU/CIS прямо в Claude.** MCP-коннектор с **94
детерминированными инструментами** и **69 готовыми сценариями (prompts)**, которые
...
*NECTARIN Intelligence · 94 инструмента · 69 сценариев · 22 профессии · установка через Unyly
