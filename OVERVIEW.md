...
**AI-маркетинг-директор для рынка RU/CIS прямо в Claude.** MCP-коннектор с **78
детерминированными инструментами** и **55 готовыми сценариями (prompts)**, которые
...
*NECTARIN Intelligence · 78 инструментов · 55 сценариев · 22 профессии · установка через Unyly
