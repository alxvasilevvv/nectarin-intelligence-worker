...
**AI-маркетинг-директор для рынка RU/CIS прямо в Claude.** MCP-коннектор с **91
детерминированными инструментами** и **66 готовыми сценариями (prompts)**, которые
...
*NECTARIN Intelligence · 91 инструмент · 66 сценариев · 22 профессии · установка через Unyly
