...
**AI-маркетинг-директор для рынка RU/CIS прямо в Claude.** MCP-коннектор с **65
детерминированными инструментами** и **42 готовыми сценариями (prompts)**, которые
...
- **42 готовых сценария.** Нажал prompt — Claude сам вызывает нужные инструменты в
...
*NECTARIN Intelligence · 65 инструментов · 42 сценария · Cloudflare Workers (edge,
