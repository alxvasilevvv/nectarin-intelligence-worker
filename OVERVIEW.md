...
**AI-маркетинг-директор для рынка RU/CIS прямо в Claude.** MCP-коннектор с **54
детерминированными инструментами** и **31 готовым сценарием (prompts)**, которые
...
- **31 готовый сценарий.** Нажал prompt — Claude сам вызывает нужные инструменты в
...
*NECTARIN Intelligence · 54 инструмента · 31 сценарий · Cloudflare Workers (edge,
