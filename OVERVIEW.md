...
**AI-маркетинг-директор для рынка RU/CIS прямо в Claude.** MCP-коннектор с **57
детерминированными инструментами** и **34 готовыми сценариями (prompts)**, которые
...
- **34 готовых сценария.** Нажал prompt — Claude сам вызывает нужные инструменты в
...
*NECTARIN Intelligence · 57 инструментов · 34 сценария · Cloudflare Workers (edge,
