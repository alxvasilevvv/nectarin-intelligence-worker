...
**AI-маркетинг-директор для рынка RU/CIS прямо в Claude.** MCP-коннектор с **102
детерминированными инструментами** и **77 готовыми сценариями (prompts)**, которые
...
*NECTARIN Intelligence · 97 инструментов · 72 сценария · 22 профессии · установка через Unyly
