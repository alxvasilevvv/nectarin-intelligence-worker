...
**AI-маркетинг-директор для рынка RU/CIS прямо в Claude.** MCP-коннектор с **73
детерминированными инструментами** и **50 готовыми сценариями (prompts)**, которые
...
- **50 готовых сценариев.** Нажал prompt — Claude сам вызывает нужные инструменты в
...
*NECTARIN Intelligence · 73 инструмента · 50 сценариев · 22 профессии · установка через Unyly ·
Cloudflare Workers (edge, MCP Streamable HTTP). Подробности — в `README.md` и `USAGE.md`.*
