...
**AI-маркетинг-директор для рынка RU/CIS прямо в Claude.** MCP-коннектор с **74
детерминированными инструментами** и **51 готовым сценарием (prompts)**, которые
...
*NECTARIN Intelligence · 74 инструмента · 51 сценарий · 22 профессии · установка через Unyly
