...
**AI-маркетинг-директор для рынка RU/CIS прямо в Claude.** MCP-коннектор с **66
детерминированными инструментами** и **43 готовыми сценариями (prompts)**, которые
...
- **43 готовых сценария.** Нажал prompt — Claude сам вызывает нужные инструменты в
...
*NECTARIN Intelligence · 66 инструментов · 43 сценария · Cloudflare Workers (edge,
